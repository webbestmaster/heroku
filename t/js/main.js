...
gi7686['/www/js/services/log.js'] = log;
...
var log = gi7686['/www/js/services/log.js'] || window.log;
...
gi7686['/www/js/services/mediator.js'] = mediator;
...
gi7686['/www/js/services/info.js'] = info;
...
var Backbone = gi7686['/www/js/lib/backbone.js'] || window.Backbone;
var mediator = gi7686['/www/js/services/mediator.js'] || window.mediator;
...
gi7686['/www/js/services/device.js'] = device;
}());
(function () {
'use strict';
/*global window, Date */

var info = gi7686['/www/js/services/info.js'] || window.info;
...
gi7686['/www/js/services/android-ads.js'] = androidAds;
...
var info = gi7686['/www/js/services/info.js'] || window.info;
var en = gi7686['/www/js/i18n/en.js'] || window.en;
var ru = gi7686['/www/js/i18n/ru.js'] || window.ru;
...
gi7686['/www/js/services/lang.js'] = lang;
...
var doT = gi7686['/www/js/lib/dot.js'] || window.doT;
...
gi7686['/www/js/services/template-master.js'] = templateMaster;
...
gi7686['/www/js/services/util.js'] = util;
}());
(function () {
'use strict';
/*global window */
...
gi7686['/www/js/sound/player-android.js'] = androidPlayer;
}());
(function () {
'use strict';
/*global window */
...
gi7686['/www/js/sound/player-ios.js'] = iosPlayer;
...
gi7686['/www/js/sound/player-web.js'] = webPlayer;
...
var androidPlayer = gi7686['/www/js/sound/player-android.js'] || window.androidPlayer;
var iosPlayer = gi7686['/www/js/sound/player-ios.js'] || window.iosPlayer;
var webPlayer = gi7686['/www/js/sound/player-web.js'] || window.webPlayer;
var info = gi7686['/www/js/services/info.js'] || window.info;
...
gi7686['/www/js/sound/sound-master.js'] = soundMaster;
...
var Backbone = gi7686['/www/js/lib/backbone.js'] || window.Backbone;
var $ = gi7686['/www/js/lib/jbone.js'] || window.$;
var _ = gi7686['/www/js/lib/lodash.js'] || window._;
var info = gi7686['/www/js/services/info.js'] || window.info;
//var tm = gi7686['/www/js/services/template-master.js'] || window.tm;
var util = gi7686['/www/js/services/util.js'] || window.util;
var mediator = gi7686['/www/js/services/mediator.js'] || window.mediator;
var sm = gi7686['/www/js/sound/sound-master.js'] || window.sm;
var lang = gi7686['/www/js/services/lang.js'] || window.lang;
var device = gi7686['/www/js/services/device.js'] || window.device;
...
gi7686['/www/js/app/view/core/base.js'] = BaseView;
}());
(function () {
'use strict';
/*global window */

var BaseView = gi7686['/www/js/app/view/core/base.js'] || window.BaseView;
var tm = gi7686['/www/js/services/template-master.js'] || window.tm;
...
gi7686['/www/js/app/view/home/home-view.js'] = HomeView;
}());
(function () {
var Backbone = gi7686['/www/js/lib/backbone.js'] || window.Backbone;
var mediator = gi7686['/www/js/services/mediator.js'] || window.mediator;
...
gi7686['/www/js/app/view/tangram/models/tan.js'] = Tan;
}());
(function () {
var Backbone = gi7686['/www/js/lib/backbone.js'] || window.Backbone;
var Tan = gi7686['/www/js/app/view/tangram/models/tan.js'] || window.Tan;
var _ = gi7686['/www/js/lib/lodash.js'] || window._;
var device = gi7686['/www/js/services/device.js'] || window.device;
var mediator = gi7686['/www/js/services/mediator.js'] || window.mediator;
var log = gi7686['/www/js/services/log.js'] || window.log;
...
gi7686['/www/js/app/view/tangram/models/tan-collection.js'] = TanCollection;
}());
(function () {
'use strict';
/*global window */
...
var BaseView = gi7686['/www/js/app/view/core/base.js'] || window.BaseView;
var tm = gi7686['/www/js/services/template-master.js'] || window.tm;
var TanCollection = gi7686['/www/js/app/view/tangram/models/tan-collection.js'] || window.TanCollection;
...
gi7686['/www/js/app/view/tangram/tangram-view.js'] = TangramView;
}());
(function () {
'use strict';
/*global window */
...
var _ = gi7686['/www/js/lib/lodash.js'] || window._;
var BaseView = gi7686['/www/js/app/view/core/base.js'] || window.BaseView;
var HomeView = gi7686['/www/js/app/view/home/home-view.js'] || window.HomeView;
var TangramView = gi7686['/www/js/app/view/tangram/tangram-view.js'] || window.TangramView;
var mediator = gi7686['/www/js/services/mediator.js'] || window.mediator;
...
gi7686['/www/js/app/router/router.js'] = router;
}());
(function () {
'use strict';
/*global window */
...
gi7686['/www/js/app/view/core/hint.js'] = hintMaster;
}());
(function () {
'use strict';
/*global window */
...
gi7686['/www/js/app/view/core/popup.js'] = popupMaster;
}());
(function () {
'use strict';
/*global window */
...
// init all librares
var polyfillClassList = gi7686['/www/js/lib/polyfill-class-list.js'] || window.polyfillClassList;
var shim = gi7686['/www/js/lib/shim.js'] || window.shim;
var shimES5 = gi7686['/www/js/lib/shim-es5.js'] || window.shimES5;
var shamES5 = gi7686['/www/js/lib/sham-es5.js'] || window.shamES5;
var _ = gi7686['/www/js/lib/lodash.js'] || window._;
var $ = gi7686['/www/js/lib/jbone.js'] || window.$;
var Deferred = gi7686['/www/js/lib/deferred.js'] || window.Deferred;
var Backbone = gi7686['/www/js/lib/backbone.js'] || window.Backbone;
var fastclick = gi7686['/www/js/lib/fastclick.js'] || window.fastclick;
var doT = gi7686['/www/js/lib/dot.js'] || window.doT;

// init all services
var info = gi7686['/www/js/services/info.js'] || window.info;
var device = gi7686['/www/js/services/device.js'] || window.device;
var androidAds = gi7686['/www/js/services/android-ads.js'] || window.androidAds;
var lang = gi7686['/www/js/services/lang.js'] || window.lang;
var tm = gi7686['/www/js/services/template-master.js'] || window.tm;
var util = gi7686['/www/js/services/util.js'] || window.util;
...
var router = gi7686['/www/js/app/router/router.js'] || window.router;

var BaseView = gi7686['/www/js/app/view/core/base.js'] || window.BaseView;
var hintMaster = gi7686['/www/js/app/view/core/hint.js'] || window.hintMaster;
var popupMaster = gi7686['/www/js/app/view/core/popup.js'] || window.popupMaster;
