...
var _libJbone = require('./../../../lib/jbone');

var _libJbone2 = _interopRequireDefault(_libJbone);
...
var win = window,
	...
	initStatic: function initStatic() {
		...
		proto.$wrapper = (0, _libJbone2['default'])(view.selectors.wrapper);
		...
		(0, _libJbone2['default'])(doc.body).on('contextmenu', view.stopEvent);
	},
	...
	constructor: function constructor() {
		...
		view.events = _libJbone2['default'].extend({}, proto.events, view.events);
		...
		view.selectors = _libJbone2['default'].extend({}, proto.selectors, view.selectors);
	...
	changeSelect: function changeSelect(e) {
		...
		var $this = (0, _libJbone2['default'])(e.currentTarget),
	...
	hide: function hide() {
		...
		var view = this,
		    ...
		    deferred = _libJbone2['default'].Deferred();
	...
	routeTo: function routeTo(e) {
		...
		var view = this,
		    $this = (0, _libJbone2['default'])(e.currentTarget),
   ...
   */
	...
	checkConnection: function checkConnection() {
		...
		var deferred = _libJbone2['default'].Deferred(),
		    src = 'https://www.gstatic.com/android/market_images/web/play_one_bar_logo.png?t=' + Math.random(),
		    $img = (0, _libJbone2['default'])('<img alt=""/>');

		$img.on('load', function () {
			(0, _libJbone2['default'])(this).off().remove();
			deferred.resolve();
		});
	...
	tabAction: function tabAction(e) {
		...
		var view = this,
		    $el = view.$el,
		    $button = (0, _libJbone2['default'])(e.currentTarget),
...
PopupView = _base2['default'].extend({
	...
	render: function render() {
		...
		var view = this,
		    ...
		    $content = (0, _libJbone2['default'])(_servicesTemplateMaster2['default'].tmplFn[view.get('name')](data)),
...
var SchedulerView = _coreBase2['default'].extend({
	...
	initialize: function initialize(data) {
		...
		view.setElement(_servicesTemplateMaster2['default'].tmplFn.scheduler({ data: data, util: _servicesUtil2['default'] }));
	...
	setState: function setState(state) {
		...
		switch (state) {
			...
			case 'occupied':
				$isAvailable.removeClass('toilet-is-available').addClass('toilet-is-occupied');

				break;

			case 'available':
				$isAvailable.removeClass('toilet-is-occupied').addClass('toilet-is-available');
				break;
	...
	setNextChangeStateTime: function setNextChangeStateTime(time) {
		...
		if (typeof time === 'number') {
			time = _servicesUtil2['default'].formatMs(time);
...
},{"./../../../services/template-master":28,"./../../../services/util":29,"./../core/base":4}],11:[function(require,module,exports){
'use strict';
/*global window */
...
!(function (a) {
  function b(b) {
    var c = b.length,
        d = typeof b;return o(d) || b === a ? !1 : 1 === b.nodeType && c ? !0 : p(d) || 0 === c || "number" == typeof c && c > 0 && c - 1 in b;
  }function c(a, b) {
    var c, d;this.originalEvent = a, d = function (a, b) {
      this[a] = "preventDefault" === a ? function () {
        return (this.defaultPrevented = !0, b[a]());
      } : "stopImmediatePropagation" === a ? function () {
        return (this.immediatePropagationStopped = !0, b[a]());
      } : o(b[a]) ? function () {
        return b[a]();
      } : b[a];
    };for (c in a) (a[c] || "function" == typeof a[c]) && d.call(this, c, a);q.extend(this, b, { isImmediatePropagationStopped: function isImmediatePropagationStopped() {
    ...
    return Array.isArray(a);
      ...
      q = function q(a, b) {
    return new d.init(a, b);
  };q.noConflict = function () {
    return (a.$ = e, a.jBone = f, q);
  }, d = q.fn = q.prototype = { init: function init(a, b) {
      var c, d, e, f;if (!a) return this;if (m(a)) {
        if (d = g.exec(a)) return (this[0] = l.createElement(d[1]), this.length = 1, n(b) && this.attr(b), this);if ((d = h.exec(a)) && d[1]) {
          for (f = l.createDocumentFragment(), e = l.createElement("div"), e.innerHTML = a; e.lastChild;) f.appendChild(e.firstChild);return (c = i.call(f.childNodes), q.merge(this, c));
        }if (q.isElement(b)) return q(b).find(a);try {
          return (c = l.querySelectorAll(a), q.merge(this, c));
        } catch (j) {
          return this;
        }
      }return a.nodeType ? (this[0] = a, this.length = 1, this) : o(a) ? a() : a instanceof q ? a : q.makeArray(a, this);
    }, pop: [].pop, push: [].push, reverse: [].reverse, shift: [].shift, sort: [].sort, splice: [].splice, slice: [].slice, indexOf: [].indexOf, forEach: [].forEach, unshift: [].unshift, concat: [].concat, join: [].join, every: [].every, some: [].some, filter: [].filter, map: [].map, reduce: [].reduce, reduceRight: [].reduceRight, length: 0 }, d.constructor = q, d.init.prototype = d, q.setId = function (b) {
    var c = b.jid;b === a ? c = "window" : void 0 === b.jid && (b.jid = c = ++q._cache.jid), q._cache.events[c] || (q._cache.events[c] = {});
  }, q.getData = function (b) {
    b = b instanceof q ? b[0] : b;var c = b === a ? "window" : b.jid;return { jid: c, events: q._cache.events[c] };
  }, q.isElement = function (a) {
    return a && a instanceof q || a instanceof HTMLElement || m(a);
  }, q._cache = { events: {}, jid: 0 }, d.pushStack = function (a) {
    var b = q.merge(this.constructor(), a);return b;
  }, q.merge = function (a, b) {
    for (var c = b.length, d = a.length, e = 0; c > e;) a[d++] = b[e++];return (a.length = d, a);
  }, q.contains = function (a, b) {
    return a.contains(b);
  }, q.extend = function (a) {
    var b;return (j.call(arguments, 1).forEach(function (c) {
      if ((b = a, c)) for (var d in c) b[d] = c[d];
    }), a);
  }, q.makeArray = function (a, c) {
    var d = c || [];return (null !== a && (b(a) ? q.merge(d, m(a) ? [a] : a) : d.push(a)), d);
  }, q.unique = function (a) {
    if (null == a) return [];for (var b = [], c = 0, d = a.length; d > c; c++) {
      var e = a[c];b.indexOf(e) < 0 && b.push(e);
    }return b;
  }, q.Event = function (a, b) {
    var c, d;return (a.type && !b && (b = a, a = a.type), c = a.split(".").splice(1).join("."), d = a.split(".")[0], a = l.createEvent("Event"), a.initEvent(d, !0, !0), q.extend(a, { namespace: c, isDefaultPrevented: function isDefaultPrevented() {
        return a.defaultPrevented;
      } }, b));
  }, q.event = { add: function add(a, b, c, d, e) {
      q.setId(a);var f,
          g,
          h,
          i = function i(b) {
        q.event.dispatch.call(a, b);
      },
          j = q.getData(a).events;for (b = b.split(" "), g = b.length; g--;) h = b[g], f = h.split(".")[0], j[f] = j[f] || [], j[f].length ? i = j[f][0].fn : a.addEventListener && a.addEventListener(f, i, !1), j[f].push({ namespace: h.split(".").splice(1).join("."), fn: i, selector: e, data: d, originfn: c });
    }, remove: function remove(a, b, c) {
      var d,
          e,
          f = function f(a, b, d, e, _f) {
        var g;(c && _f.originfn === c || !c) && (g = _f.fn), a[b][d].fn === g && (a[b].splice(d, 1), a[b].length || e.removeEventListener(b, g));
      },
          g = q.getData(a).events;if (g) return !b && g ? k(g).forEach(function (b) {
        for (e = g[b], d = e.length; d--;) f(g, b, d, a, e[d]);
      }) : void b.split(" ").forEach(function (b) {
        var c,
            h = b.split(".")[0],
            i = b.split(".").splice(1).join(".");if (g[h]) for (e = g[h], d = e.length; d--;) c = e[d], (!i || i && c.namespace === i) && f(g, h, d, a, c);else i && k(g).forEach(function (b) {
          for (e = g[b], d = e.length; d--;) c = e[d], c.namespace.split(".")[0] === i.split(".")[0] && f(g, b, d, a, c);
        });
      });
    }, trigger: function trigger(a, b) {
      var c = [];m(b) ? c = b.split(" ").map(function (a) {
        return q.Event(a);
      }) : (b = b instanceof Event ? b : q.Event(b), c = [b]), c.forEach(function (b) {
        b.type && a.dispatchEvent && a.dispatchEvent(b);
      });
    }, dispatch: function dispatch(a) {
      for (var b, d, e, f, g, h = 0, i = 0, j = this, k = q.getData(j).events[a.type], l = k.length, m = [], n = []; l > h; h++) m.push(k[h]);for (h = 0, l = m.length; l > h && ~k.indexOf(m[h]) && (!f || !f.isImmediatePropagationStopped()); h++) if ((d = null, g = {}, e = m[h], e.data && (g.data = e.data), e.selector)) {
        if (~(n = q(j).find(e.selector)).indexOf(a.target) && (d = a.target) || j !== a.target && j.contains(a.target)) {
          if (!d) for (b = n.length, i = 0; b > i; i++) n[i] && n[i].contains(a.target) && (d = n[i]);if (!d) continue;g.currentTarget = d, f = new c(a, g), a.namespace && a.namespace !== e.namespace || e.originfn.call(d, f);
        }
      } else f = new c(a, g), a.namespace && a.namespace !== e.namespace || e.originfn.call(j, f);
    } }, d.on = function (a, b, c, d) {
    var e = this.length,
        f = 0;if ((null == c && null == d ? (d = b, c = b = void 0) : null == d && ("string" == typeof b ? (d = c, c = void 0) : (d = c, c = b, b = void 0)), !d)) return this;for (; e > f; f++) q.event.add(this[f], a, d, c, b);return this;
  }, d.one = function (a) {
    var b,
        c = arguments,
        d = 0,
        e = this.length,
        f = i.call(c, 1, c.length - 1),
        g = i.call(c, -1)[0];for (b = function (b) {
      var c = q(b);a.split(" ").forEach(function (a) {
        var d = function d(e) {
          c.off(a, d), g.call(b, e);
        };c.on.apply(c, [a].concat(f, d));
      });
    }; e > d; d++) b(this[d]);return this;
  }, d.trigger = function (a) {
    var b = 0,
        c = this.length;if (!a) return this;for (; c > b; b++) q.event.trigger(this[b], a);return this;
  }, d.off = function (a, b) {
    for (var c = 0, d = this.length; d > c; c++) q.event.remove(this[c], a, b);return this;
  }, d.find = function (a) {
    for (var b = [], c = 0, d = this.length, e = function e(c) {
      o(c.querySelectorAll) && [].forEach.call(c.querySelectorAll(a), function (a) {
        b.push(a);
      });
    }; d > c; c++) e(this[c]);return q(b);
  }, d.get = function (a) {
    return null != a ? 0 > a ? this[a + this.length] : this[a] : i.call(this);
  }, d.eq = function (a) {
    return q(this[a]);
  }, d.parent = function () {
    for (var a, b = [], c = 0, d = this.length; d > c; c++) ! ~b.indexOf(a = this[c].parentElement) && a && b.push(a);return q(b);
  }, d.toArray = function () {
    return i.call(this);
  }, d.is = function () {
    var a = arguments;return this.some(function (b) {
      return b.tagName.toLowerCase() === a[0];
    });
  }, d.has = function () {
    var a = arguments;return this.some(function (b) {
      return b.querySelectorAll(a[0]).length;
    });
  }, d.add = function (a, b) {
    ...
    var c,
        d = arguments,
        e = 0,
        f = this.length;if (m(a) && 1 === d.length) return this[0] && this[0].getAttribute(a);for (2 === d.length ? c = function (c) {
      c.setAttribute(a, b);
    } : n(a) && (c = function (b) {
      k(a).forEach(function (c) {
        b.setAttribute(c, a[c]);
      });
    }); f > e; e++) c(this[e]);return this;
  }, d.removeAttr = function (a) {
    for (var b = 0, c = this.length; c > b; b++) this[b].removeAttribute(a);return this;
  }, d.val = function (a) {
    var b = 0,
        c = this.length;if (0 === arguments.length) return this[0] && this[0].value;for (; c > b; b++) this[b].value = a;return this;
  }, d.css = function (b, c) {
    var d,
        e = arguments,
        f = 0,
        g = this.length;if (m(b) && 1 === e.length) return this[0] && a.getComputedStyle(this[0])[b];for (2 === e.length ? d = function (a) {
      a.style[b] = c;
    } : n(b) && (d = function (a) {
      k(b).forEach(function (c) {
        a.style[c] = b[c];
      });
    }); g > f; f++) d(this[f]);return this;
  }, d.data = function (a, b) {
    var c,
        d = arguments,
        e = {},
        ...
        g = this.length,
        h = function h(a, b, c) {
      n(c) ? (a.jdata = a.jdata || {}, a.jdata[b] = c) : a.dataset[b] = c;
    },
        i = function i(a) {
      return "true" === a ? !0 : "false" === a ? !1 : a;
    };if (0 === d.length) return (this[0].jdata && (e = this[0].jdata), k(this[0].dataset).forEach(function (a) {
      e[a] = i(this[0].dataset[a]);
    }, this), e);if (1 === d.length && m(a)) return this[0] && i(this[0].dataset[a] || this[0].jdata && this[0].jdata[a]);for (1 === d.length && n(a) ? c = function (b) {
      k(a).forEach(function (c) {
        h(b, c, a[c]);
      });
    } : 2 === d.length && (c = function (c) {
      h(c, a, b);
    }); g > f; f++) c(this[f]);return this;
  }, d.removeData = function (a) {
    for (var b, c, d = 0, e = this.length; e > d; d++) if ((b = this[d].jdata, c = this[d].dataset, a)) b && b[a] && delete b[a], delete c[a];else {
      for (a in b) delete b[a];for (a in c) delete c[a];
    }return this;
  }, d.addClass = function (a) {
    for (var b = 0, c = 0, d = this.length, e = a ? a.trim().split(/\s+/) : []; d > b; b++) for (c = 0, c = 0; c < e.length; c++) this[b].classList.add(e[c]);return this;
  }, d.removeClass = function (a) {
    for (var b = 0, c = 0, d = this.length, e = a ? a.trim().split(/\s+/) : []; d > b; b++) for (c = 0, c = 0; c < e.length; c++) this[b].classList.remove(e[c]);return this;
  }, d.toggleClass = function (a, b) {
    var c = 0,
        d = this.length,
        e = "toggle";if ((b === !0 && (e = "add") || b === !1 && (e = "remove"), a)) for (; d > c; c++) this[c].classList[e](a);return this;
  }, d.hasClass = function (a) {
    var b = 0,
        c = this.length;if (a) for (; c > b; b++) if (this[b].classList.contains(a)) return !0;return !1;
  }, d.html = function (a) {
    var b,
        c = arguments;return 1 === c.length && void 0 !== a ? this.empty().append(a) : 0 === c.length && (b = this[0]) ? b.innerHTML : this;
  }, d.append = function (a) {
    var b,
        c = 0,
        d = this.length;for (m(a) && h.exec(a) ? a = q(a) : n(a) || (a = document.createTextNode(a)), a = a instanceof q ? a : q(a), b = function (b, c) {
      a.forEach(function (a) {
        b.appendChild(c ? a.cloneNode(!0) : a);
      });
    }; d > c; c++) b(this[c], c);return this;
  }, d.appendTo = function (a) {
    return (q(a).append(this), this);
  }, d.empty = function () {
    for (var a, b = 0, c = this.length; c > b; b++) for (a = this[b]; a.lastChild;) a.removeChild(a.lastChild);return this;
  }, d.remove = function () {
    var a,
        b = 0,
        c = this.length;for (this.off(); c > b; b++) a = this[b], delete a.jdata, a.parentNode && a.parentNode.removeChild(a);return this;
  }, "object" == typeof module && module && "object" == typeof module.exports ? module.exports = q : "function" == typeof define && define.amd ? (define(function () {
    return q;
...
var _libDeferred = require('./lib/deferred');

var _libDeferred2 = _interopRequireDefault(_libDeferred);
...
new _libFastclick2['default'](window.document.body); // test it decide
...
(function back() {
	...
	_libDeferred2['default'].installInto(_libJbone2['default']);

	win.$ = win.jQuery = win.jquery = _libJbone2['default'];
	...
	init: function init() {
		...
		Array.prototype.forEach.call(templates, function (tmplNode) {
			...
			var name = tmplNode.getAttribute('data-name'),
			    text = tmplNode.innerHTML.replace(/\&(amp|gt|lt|%7B|%7D|%20)\;/gi, tm.getSymbolByMap);
...
util = {
	...
	formatTime: function formatTime(number) {
